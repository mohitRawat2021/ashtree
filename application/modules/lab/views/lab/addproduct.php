    ...
    <div class="container-fluid">
        ...
        <div class="row pt-2 pb-2">
            ...
            <div class="col-sm-3">
                <div class="btn-group float-sm-right">
                    <a href="<?=base_url('store/product')?>" class="btn btn-outline-primary waves-effect waves-light">Product List</a>
                </div>
            </div>
        </div>
        <!-- End Breadcrumb-->
        ...
        <div class="row">
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Add Item Details</div>
                        <hr>
                        <form method="post" action="<?=base_url('restaurant/addProduct')?>" id="all_mall" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control form-control-square" name="price" value="<?=set_value('price')?>" placeholder="Enter item Price">
                                    <?=form_error('price')?>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <textarea class="form-control form-control-square" name="other_details"><?=set_value('name')?></textarea>
