            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('restaurant/faq')?>"> 
                            <div class="form-group row">
                                <label class="col-sm-1 col-form-label">FAQ's</label>
                                 <div class="col-sm-5">
                                      <textarea name="faq" rows='10' class="form-control"><?=set_value('faq')?><?=@$insert_into->faq?></textarea>
                                       <?=form_error('faq')?>
                                 </div>
                            </div>
