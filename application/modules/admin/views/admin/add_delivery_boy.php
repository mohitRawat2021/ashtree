            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('admin/add_deliverboy')?>" id="" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" class="form-control form-control-square" name="driving_license" value="<?=set_value('driving_license')?>" placeholder="Driving License">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" id="address-input" class="form-control form-control-square map-input" name="delivery_area" value="<?=set_value('delivery_area')?>" placeholder="Delivery Area">
