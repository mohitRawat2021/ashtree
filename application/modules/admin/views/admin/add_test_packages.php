            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('admin/add_test_packages')?>" enctype="multipart/form-data"> 
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Packages Name</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Packages Price</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Packages Thumb Image</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Packages Image</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Packages Information</label>
                                <div class="col-sm-8">
