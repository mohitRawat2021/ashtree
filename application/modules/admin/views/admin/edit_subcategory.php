            ...
            <div class="col-lg-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form method="post" action="<?=base_url('admin/edit_subcategory/').$this->uri->segment('3')?>" id="" enctype="multipart/form-data">
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Category Type</label>
                                    <div class="col-sm-3">
                                        <select class="form-control" name="cat_type" id="cat_type">
                                            <option value="">Select</option>
                                            <option value="0" <?= $subcategory_details->category_type=='0'?'selected':''?>>Store</option>
                                            <option value="1" <?= $subcategory_details->category_type=='1'?'selected':''?>>Restaurant</option>
                                        </select>                                 
                                    </div>                            
                            </div>
                            <div class="form-group row">
